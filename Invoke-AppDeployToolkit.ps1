...
function Install-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses OpenChrom -CheckDiskSpace -PersistPrompt
...
function Uninstall-ADTDeployment
{
    ...
    Start-ADTProcess -FilePath 'C:\Program Files\OpenChrom\uninstall.exe' -ArgumentList '/S' -WindowStyle 'Hidden'
    ...
    Remove-ADTFile -Path "$envCommonStartMenu\Programs\OpenChrom\OpenChrom.lnk" -Recurse
